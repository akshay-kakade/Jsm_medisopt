...
export const gatRecentAppointmentList = async () => {
    try {
...
export const updateAppointment = async ({ appointmentId, userId, appointment, type }: UpdateAppointmentParams) => {
    try {
        ...
        `We regret to inform you Your appointment has been cancelled. for the following reason: ${appointment.cancellationReason}`}
           `
